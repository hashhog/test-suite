...
#   (RPC 40119, P2P 40139). To give BOTH nodes the IDENTICAL UTXO set (so the
...
#
# Touches ONLY /tmp/sts-haskoin* + /tmp/sts-core* and ports 40119/40139
#   (haskoin RPC/P2P) + 40219/40239 (Core RPC/P2P). NEVER touches /data/nvme1/
